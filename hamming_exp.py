...
def main():
    ...
    full_info1 = ''.join(random.choice('0') for _ in range(info_length+f_length))
    ...
    for _ in range(50):
        ...
        info_word2 = ''.join(random.choice('01') for _ in range(info_length))
        ...
        for i in range(2**f_length):
            ...
            redundant_bits1 = code_word1[info_length:]
            redundant_bits2 = code_word2[info_length:]
            ...
            if transition_count <= 2:
                cnt_2 += 1
                print("--------------------------------------------------")
                print(f"C_prev: {code_word1[0:info_length]} | {code_word1[info_length:info_length+f_length]} | {code_word1[info_length+f_length:]}")
                print(f"C_new : {code_word2[0:info_length]} | {code_word2[info_length:info_length+f_length]} | {code_word2[info_length+f_length:]}")
